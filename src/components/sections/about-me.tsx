      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mb-16">
          <p className="mx-auto max-w-2xl text-center text-gray-800">
            ...
            about building scalable web applications and crafting seamless user
            experiences. My journey began with front-end development, and I’ve
            since expanded my skills into backend technologies to create
            full-stack solutions. I hold a degree in Software Engineering, where
        ...
        <div className="mb-20 flex items-center justify-center">
          ...
          <div className="mx-2">
            ...
            >
              <path
                d="M0 6L6 0L12 6L18 0L24 6L18 12L12 6L6 12L0 6Z"
                fill="black"
              />
            </svg>
          </div>
        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-2">
          ...
          <div className="flex flex-col items-center">
            ...
            <h2 className="mb-4 text-xl font-bold tracking-widest">DESIGN</h2>
            <p className="max-w-xs text-center text-sm text-gray-700">
              Crafting visually appealing and user-friendly designs that enhance
              the user experience.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="max-w-xs text-center text-sm text-gray-700">
              Building scalable and high-performance applications with modern
              technologies.
            </p>
          </div>
          ...
          <div className="mt-8 flex flex-col items-center md:col-span-2 md:mt-16">
            ...
            <p className="max-w-xs text-center text-sm text-gray-700">
              Ensuring seamless performance, security updates, and continuous
              improvements.
            </p>
          </div>
        </div>
